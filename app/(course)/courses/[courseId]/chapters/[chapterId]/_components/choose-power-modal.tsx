...
export default function ChoosePowerModal({ onClose, onPowerSelection }: ChoosePowerModalProps) {
  ...
  return (
    <Dialog open={true} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[700px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-2xl font-bold">Choose Your Powers</DialogTitle>
        ...
        <div className="py-4">
          <div className="flex justify-between items-center mb-4">
            <div className="text-sm font-medium">Selected: {selectedPowers.length}/3 powers</div>
